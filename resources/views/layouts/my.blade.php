        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li>
                <a href="#applicantdropdownDropdown" aria-expanded="false" data-toggle="collapse">
                    <i class="fa fa-users" style="font-size:20px;color:#208000"></i>Applicants
                </a>
                    <ul id="applicantdropdownDropdown" class="collapse list-unstyled ">
                        <li>
                            <a href="{{route('applicant.create')}}">
                                <i class="fa fa-plus-circle" style="font-size:20px;color:green"></i> Add Applicants
                            </a>
                        </li>
            ...
            <li>
                <a href="#companydropdownDropdown" aria-expanded="false" data-toggle="collapse">
                    <i class="fa fa-building" style="font-size:20px;color:#995c00"></i> Companies
                </a>
                    <ul id="companydropdownDropdown" class="collapse list-unstyled ">
                        <li>
                            <a href="{{route('company.create')}}">
                                <i class="fa fa-plus-circle" style="font-size:20px;color:green"></i> Add Companies
                            </a>
                        </li>
            ...
            <li>
                <a href="#vaconcydropdownDropdown" aria-expanded="false" data-toggle="collapse">
                    <i class="fa fa-newspaper-o" style="font-size:20px;color:#ff4000" ></i> Vacancies
                </a>
                    <ul id="vaconcydropdownDropdown" class="collapse list-unstyled ">
                        <li>
                            <a href="{{route('vacancy.create')}}">
                                <i class="fa fa-plus-circle" style="font-size:20px;color:green"></i> Add Vacancy
                            </a>
                        </li>
                        <li>
            ...
            <li>
                <a href="#interviewdropdownDropdown" aria-expanded="false" data-toggle="collapse">
                    <i class="fa fa-handshake-o" style="font-size:20px;color:#999900" ></i> Interviews
                </a>
                    <ul id="interviewdropdownDropdown" class="collapse list-unstyled ">
                        <li>
                            <a href="{{route('interview.create')}}">
                                <i class="fa fa-plus-circle" style="font-size:20px;color:green"></i> Add Interview
                            </a>
                        </li>
                        <li>
            ...
            <li>
                <a href="{{route('category.index')}}" >
                    <i class="icon-check" style="font-size:20px;color:#ff9933"></i> Categories
                </a>
            ...
            <li>
                <a href="{{route('title.index')}}" >
                    <i class="icon-list" style="font-size:20px;color:#009933"></i> Job Title
                </a>
          ...
          <div class="container-fluid">
            ...
            <a href="{{route('welcome')}}" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block">
                    <strong class="text-primary">Mozita
                    </strong>
                    <span>ADMIN </span>
                    </div>
                </a>
