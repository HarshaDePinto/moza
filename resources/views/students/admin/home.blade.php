        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="wrapper count-title d-flex">
                        ...
                        <div class="name">
                            <strong class="text-uppercase">
                                <a class="text-success" href="">Students
                                </a>
                            </strong>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="wrapper count-title d-flex">
                        <div class="icon">
                            <i class="fa fa-university" style="color:#995c00"></i>
                        </div>
                        <div class="name">
                            <strong class="text-uppercase">
                                <a class="text-success" href="">colleges
                                </a>
                            </strong>
                            <div class="count-number">
                                15
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="wrapper count-title d-flex">
                        <div class="icon">
                            <i class="fa fa-mortar-board" style="color:#ff9933"></i>
                        </div>
                        <div class="name">
                            <strong class="text-uppercase">
                                <a class="text-success" href="{{route('stuLev.index')}}">Level
                                </a>
                            </strong>
                            <div class="count-number">
                                {{$levels->count()}}
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="wrapper count-title d-flex">
                        <div class="icon">
                            <i class="icon-check" style="color:#ff4000" ></i>
                        </div>
                        <div class="name">
                            <strong class="text-uppercase">
                                <a class="text-success" href="">Subjects
                                </a>
                            </strong>
                            <div class="count-number">
                                15
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="wrapper count-title d-flex">
                        <div class="icon">
                            <i class="fa fa-certificate" style="color:#999900"></i>
                        </div>
                        <div class="name">
                            <strong class="text-uppercase">
                                <a class="text-success" href="">Courses
                                </a>
                            </strong>
                            <div class="count-number">
                                15
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="wrapper count-title d-flex">
                        <div class="icon">
                            <i class="fa fa-bell" style="color:#990033"></i>
                        </div>
                        <div class="name">
                            <strong class="text-uppercase">
                                <a class="text-success" href="{{route('subscribe.index')}}">subscribers
                                </a>
                            </strong>
                            <div class="count-number">
                                {{$subscribes->count()}}
