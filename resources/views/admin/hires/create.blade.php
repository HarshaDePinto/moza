            ...
            <div class="col-lg-12">
                <div class="card">
                  <div class="card-header d-flex align-items-center">
                    ...
                    @endif
                    <h4 class="ml-4">Applicant Hire</h4>

                  </div>
                  <div class="card-body">


                    <form class="form-horizontal" action="{{isset($applicant)?route('hire.store',$applicant->id):route('hire.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label class="col-sm-2 form-control-label" for="date">Hired date </label>
                        <div class="col-sm-10">
