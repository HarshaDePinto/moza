...
<section>
    <div class="container-fluid">
      <!-- Page Header-->
      <button class="tablink" onclick="openPage('Home', this, '#1c1b1b')">By Title</button>
      ...
      <div id="Home" class="tabcontent">
        <h3>Select Title</h3>
      <form class="form-horizontal" action="{{route('apTitle')}}" method="POST" enctype="multipart/form-data">
            @csrf

            @foreach ($categoryName->titles as $title)
            <div class="i-checks">
      ...
      <div id="Contact" class="tabcontent">
        <h3>Experiance</h3>
        <button style="background-color:#00bfff ;" class="btn   text-white" onclick="show('operation1')"><i class="fas fa-user-tie"></i> Less Than 1 year</button>
        <button style="background-color:#ff8000 ;" class="btn   text-white" onclick="show('operation2')"><i class="fas fa-user-tie"></i> Two to Three</button>
        <button style="background-color:#0099ff ;" class="btn   text-white" onclick="show('operation3')"><i class="fas fa-user-tie"></i> Three to Five</button>

        <button style="background-color:#cc6600 ;" class="btn   text-white" onclick="show('operation4')"><i class="fas fa-user-tie"></i> Greater Than Five</button>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <h4>Applicants Belongs to {{$categoryName->name}}</h4>
                </div>
                <div class="card-body">
...
<div id="operation1" style="display:none">
    <div class="card">
        <div class="card-header">
        <h4>Applicants in {{$categoryName->name}} Less Than 1 year Experiance</h4>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
...
<div id="operation2" style="display:none">
    <div class="card">
        <div class="card-header">
        <h4>Applicants in {{$categoryName->name}} Two to Three year Experiance</h4>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
...
<div id="operation3" style="display:none">
    <div class="card">
        <div class="card-header">
        <h4>Applicants in {{$categoryName->name}} Three to Five year Experiance</h4>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
...
<div id="operation4" style="display:none">
    <div class="card">
        <div class="card-header">
        <h4>Applicants in {{$categoryName->name}} Greater Than Five years Experiance</h4>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
...
<div id="operation5" style="display:none">
    <div class="card">
        <div class="card-header">
        <h4>Applicants in {{$categoryName->name}} Level 1</h4>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
...
<div id="operation6" style="display:none">
    <div class="card">
        <div class="card-header">
        <h4>Applicants in {{$categoryName->name}} Level 2</h4>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
...
<div id="operation7" style="display:none">
    <div class="card">
        <div class="card-header">
        <h4>Applicants in {{$categoryName->name}} Level 3</h4>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
...
<div id="operation8" style="display:none">
    <div class="card">
        <div class="card-header">
        <h4>Applicants in {{$categoryName->name}} Level 4</h4>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
...
<div id="operation9" style="display:none">
    <div class="card">
        <div class="card-header">
        <h4>Applicants in {{$categoryName->name}} Level 5</h4>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
