...
@section('title')
Mozita Group &#8211; Connecting talent with opportunity
@endsection
...
@section('slider')
    <div id="home" class="slider-area">
        ...
        <div id="ensign-nivoslider" class="slides">
            <img src="{{ asset('public/moza/img/slider/working.jpg') }}" alt="" title="#slider-direction-1" />
            <img src="{{ asset('public/moza/img/slider/group.jpg') }}" alt="" title="#slider-direction-2" />
        ...
        <div id="slider-direction-1" class="slider-direction slider-one">
            ...
            <div class="row">
                ...
                <div class="slider-content">
                    ...
                    <h2 class="title1">Welcome To Mozita Group </h2>
                    </div>
                    <!-- layer 2 -->
                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                    <h1 class="title2">Make your dreams a reality with experts who care</h1>
                    </div>
                    <!-- layer 3 -->
                    <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                    <a class="ready-btn right-btn page-scroll" href="{{route('newZealand')}}">
                        New Zealand
        ...
        <div id="slider-direction-2" class="slider-direction slider-two">
            ...
            <div class="row">
                ...
                <div class="slider-content text-center">
                    ...
                    <!-- layer 2 -->
                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                    <h1 class="title2">Introducing professional to New Zealand.</h1>
                    </div>
                    <!-- layer 3 -->
                    <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                    <a class="ready-btn right-btn page-scroll" href="{{route('newZealand')}}">
